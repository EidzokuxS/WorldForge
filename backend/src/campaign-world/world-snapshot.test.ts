...
function snapshotDraft(): CampaignWorldDraft {
  return {
    ...
    placements: [
      ...
      { id: "placement-b", actorId: "actor-b", locationId: "location-a", placementKind: "base" },
      { id: "placement-c", actorId: "actor-c", locationId: "location-b", placementKind: "present" },
    ],
    pressures: [
      { id: "pressure-b", name: "Bells", description: "Signals fail.", trajectory: "Trust declines.", urgency: 3, actorIds: ["actor-d"], locationIds: ["location-c"] },
...
describe("Campaign World canonical snapshot", () => {
  ...
  it("changes the hash for source or canonical content changes", () => {
    ...
    changed.actors[0].summary = "A changed collective summary.";
