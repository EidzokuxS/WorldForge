...
export function buildWorldDnaPacketPromptContract(): string {
  return [
    ...
    "Caps: each non-cultural value is exactly one sentence of 12-24 words and at most 180 characters; each reasoning is exactly one sentence of 8-18 words and at most 180 characters; culturalFlavor.value has 2-3 items; each item has 6-10 words and at most 72 characters.",
    "Sentence rules: each non-cultural value and reasoning has one sentence ending in a period; use no second sentence.",
    ...
    "Minimal valid output: { \"geography\": { \"value\": \"A rain-lashed volcanic coast links three ports through narrow mountain passes at dusk.\", \"reasoning\": \"The premise ties travel, hazards, and settlement to one constrained coastal route.\" }, \"politicalStructure\": { \"value\": \"Harbor councils ration safe passage while elected captains enforce shared navigation laws.\", \"reasoning\": \"Coastal danger makes navigation authority the practical source of political power.\" }, \"centralConflict\": { \"value\": \"Rival ports contest the only stable channel as a hidden signal spreads among crews.\", \"reasoning\": \"The channel links survival, rivalry, and the packet's central mystery.\" }, \"culturalFlavor\": { \"value\": [\"Dockhands knot ash loops before lifts; cuts void debts\", \"Ferry families burn brass threads before every crossing\"], \"reasoning\": \"These practices make obligation and survival visible in daily work.\" }, \"environment\": { \"value\": \"Salt fog and black rain hide cliffs while volcanic vents warm the harbors.\", \"reasoning\": \"Weather and terrain turn each journey into a sensory physical hazard.\" }, \"wildcard\": { \"value\": \"Every lighthouse remembers one sailor's name and whispers it during storms nearby.\", \"reasoning\": \"The memorial phenomenon adds mystery without replacing the established conflict.\" } }",
