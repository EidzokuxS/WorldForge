...
function commandFixtures(): RulebookBatchCommand[] {
  return [
    ...
    },
    {
      ...
      goalId: "goal_rope_mender_trade",
      planId: "plan_rope_mender_trade",
      scheduleId: "schedule_rope_mender_trade",
      name: "Sella Rook",
      summary: "A rope mender carrying a waxed canvas tool roll.",
      traits: ["plainspoken", "patient"],
      tags: ["artisan", "resident"],
      goalHorizon: "ongoing",
      goalObjective: "Earn enough before rain closes the bridge market.",
      goalMotivation: "Keep the family workshop supplied through the wet season.",
      priority: 3,
      planIntentKind: "contact",
      planMethod: "Offer practical repairs to travelers at the bridge",
      planStakes: "A missed market day leaves the workshop short of lamp oil.",
      cadenceMinutes: 30,
      steps: [{
        intentKind: "contact",
        method: "Inspect a traveler's damaged gear and quote a fair repair",
        stakes: "Secure one paying repair before the rain arrives.",
