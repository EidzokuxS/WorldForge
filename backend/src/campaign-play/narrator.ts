...
- Opening: use openingContext to establish the player's present situation. Begin with the player's specific arrival, immediate situation, or a concrete change that demands attention. Use currentLocation to orient that moment, but do not paraphrase its description as a standalone tour of the setting. Convey only the pressure or calm openingContext supplies, and leave concrete room to act. Mention a visible actor only when their presence matters now. Use orientation for the first beat.
