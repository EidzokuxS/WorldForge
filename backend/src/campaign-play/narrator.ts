...
const requiredReplyDetailPromptInstruction = "When requiredReplyDetail is present, it contains only the player's exact spoken words addressed to the required actor, preferably a concise first-person utterance. Do not include a speaker tag, quotation marks, stage direction, narrated movement, or an action instruction. A plain contact reply has no mechanical authority. It may ask, clarify, negotiate, refuse, or confirm an immediate packet-supported fact. It must not accept, promise, undertake, or create work, service, delivery, cargo, payment, debt, or another future obligation or actionable reliance; those outcomes require an exact application-owned typed decision or commitment on the selected action. An atmospheric offer or bargain does not authorize them. The application adds quotation marks and binds this utterance to the contact intent.";
...
function mechanicalTruthReviewPrompt(
  ...
  return [
    ...
    "unsupported_obligation_or_payment: mark unsupported for an actionable accepted deal, job, cargo, delivery duty, fee due, payment made, or debt without an exact typed decision, commitment, payment, obligations entry, or settled actionContext.obligationSettlement. Also mark unsupported when requiredReplyDetail on a plain contact intent accepts, promises, undertakes, or creates work, service, delivery, cargo, payment, debt, or another future obligation or actionable reliance; a question, clarification, negotiation, refusal, or confirmation of an immediate packet-supported fact remains allowed. Spoken words do not count as typed authority, and an unrelated typed control cannot authorize the plain contact reply. When actionContext.obligationSettlement.status is settled, the debtor identified by debtorHandle paid you exactly amount unitKey, and that exact obligationHandle is settled; it does not authorize another payment, debt, ownership, custody, delivery, commitment, or world change. A quoted price, purchase, offer, promise, or background bargain remains allowed as incidental atmosphere when it does not assert a binding outcome, actionable future reliance, or a state change.",
