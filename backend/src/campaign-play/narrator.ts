...
function assertProposalForPacket(
  ...
  if (
    ...
    proposal.actionSelections.some((selection) => {
      ...
      return intent?.kind === "move" ? selection.detail !== null : selection.detail === null;
    })
  ) {
