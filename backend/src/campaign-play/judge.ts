...
function prompt(frame: CampaignPlayJudgeFrame, input: CampaignPlayJudgeInput): string {
  ...
  return [
    ...
    "For uncertain rulings, uncertainty.kind must be check and must include dieSides=20, difficulty, modifierMinimum, and modifierMaximum. Code performs the roll; never claim a roll result.",
