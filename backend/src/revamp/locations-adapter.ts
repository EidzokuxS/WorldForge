...
function locationNodeType(location: LocationInput): RevampWorldNode["type"] {
...
function locationRecordToNode(record: LocationRecord): RevampWorldNode {
  return {
    id: record.id,
    type: record.type,
...
function pushEdge(edges: RevampWorldEdge[], edge: RevampWorldEdge): void {
