...
export function buildCleanNarrationSystemPrompt(
  ...
  return [
    ...
    "For support_actor_materialization, express the accepted visible support actor as a support_actor_presence_line centered on actor label, ordinary role, and exact scene anchor.",
