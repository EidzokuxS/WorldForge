...
function selectDirectSceneInventoryStatusFactRefs(move: CleanNarratorPageTaskMove): string[] {
  ...
  return sentencePlanFactRefsByRole(move, ["inventory_status_beat", "inventory_labels"]);
}
