...
function buildToolRequestSystemPrompt(): string {
  return [
    ...
    "support_actor.create.v2 must never create Player, the player's label, or any actor already present in packet.scene.actors. It is not a visibility lookup or a way to answer who is nearby.",
