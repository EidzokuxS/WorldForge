...
- Capture the complete evidence bundle for the first playable slice, 20-turn proof, 30-turn diagnosis, one reusable-template lane, one newly accepted world that becomes a reusable template, one clone/provenance pristine 60-turn campaign, and a 300-turn soak.
