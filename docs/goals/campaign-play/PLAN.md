...
Current observations identify a person only through a code-owned performing-actor or observation-subject binding. Actorless sound, motion, traces, and resemblance remain unattributed in narration; prose cannot promote them into actor identity or placement authority.
