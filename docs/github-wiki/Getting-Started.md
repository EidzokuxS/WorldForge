...
- Node.js 20 or newer.
- npm.
- At least one AI provider/model endpoint configured in the app.

WorldForge runs locally in your browser. Your campaign files are stored on your machine.
...
> A rain-soaked city where ghosts are used as witnesses in court, but one ghost has started lying.
