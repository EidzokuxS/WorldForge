...
- [x] Archive remaining root evidence/tooling islands: `scripts/`, `output/`, `.planning/`.
...
- `scripts/`, `output/`, and `.planning/` were removed from the root and preserved under `docs/archive/revamp-cleanup/`.
