...
- Final focused verification passes 81/81 across visibility, Turn, Opening, Narrator, and projection suites plus backend typecheck. The fresh campaign proves the pressure and player-movement visibility repairs, person-owned autonomous work, canonical movement, and post-move continuity; the broader four-root promotion item remains open until the input-history root is exercised in the same fresh manual lane.
