...
**Depends on:** Phase 87
**Plans:** 0/11 implementation plans complete - PLANNED / EXECUTION WAVES DOCUMENTED / READY AFTER PHASE 87

Execution order: `88-EXECUTION-WAVES.md`

Plans:
- [ ] 88-01-PLAN.md - Authority spine data model.
- [ ] 88-02-PLAN.md - POV and redaction contracts.
- [ ] 88-03-PLAN.md - Versioned queue, proposals, and truthful turn boundary.
- [ ] 88-04-PLAN.md - KeyActorProcess scheduler and wakeups.
- [ ] 88-05-PLAN.md - ActorDecisionPacket and actor tool validation.
- [ ] 88-06-PLAN.md - World-time plan executor and offscreen catch-up.
- [ ] 88-07-PLAN.md - Memory, beliefs, and knowledge propagation.
- [ ] 88-08-PLAN.md - Faction command networks.
- [ ] 88-09-PLAN.md - World threads and diegetic surfacing.
- [ ] 88-10-PLAN.md - Latency, context-budget, and parallel execution observability.
- [ ] 88-11-PLAN.md - Rollback, checkpoint, and living-world verification gate.
