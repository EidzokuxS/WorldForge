...
- Expose `POST /api/revamp/campaigns/:id/setup/start`.
...
- [sourced] A7 produces `RevampStartingSetup`.
...
- [inspected] `RevampStartingSetup` already has anchor, present cast, nearby cast, pressure, hook, truth, situation, and question fields.
