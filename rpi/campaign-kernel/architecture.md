# WorldForge Campaign Kernel Architecture
...
The old implementation is a reference source. The campaign kernel path owns new contracts, new proof gates, and new player-visible behavior.
