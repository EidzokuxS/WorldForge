...
- Return `CampaignStateWriterResult` with applied and rejected change counts.
- Expose `POST /api/kernel/campaigns/:id/state/apply`.
...
- [executed] Focused campaign kernel backend suite passed: 15 files, 78 tests.
