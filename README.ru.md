...
AGPL-3.0 — см. [LICENSE](LICENSE). Свободное использование, модификация и распространение, но все производные работы обязаны оставаться open-source под той же лицензией. Коммерческое лицензирование по запросу.
