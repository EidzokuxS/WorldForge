...
Campaign Play 1.0 квалифицирован на Z.AI Coding Plan с `glm-5.3`. Релиз прошёл две свежие кампании по 60 действий через собранный интерфейс: одну в заново созданном мире и одну из provenance clone. В обеих кампаниях успешно прошли проверки сохранений, перезагрузки, replay и целостности данных.

Другие сочетания провайдеров и моделей по-прежнему можно настроить, но они не входят в поддержку Campaign Play 1.0.
