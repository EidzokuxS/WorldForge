...
This project is indexed by GitNexus as **WorldForge** (9432 symbols, 26152 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
