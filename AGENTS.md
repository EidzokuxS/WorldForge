...
This project is indexed by GitNexus as **WorldForge** (6868 symbols, 20333 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
