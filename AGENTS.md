...
This project is indexed by GitNexus as **WorldForge** (6858 symbols, 20336 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
