...
This project is indexed by GitNexus as **WorldForge** (6865 symbols, 20330 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
